<?php
class BaiduNews{
	public static function getCivilNews($count = 5){
		return self::getNews('http://news.baidu.com/n?cmd=1&class=civilnews&tn=rss', $count);
	}

	public static function getInterNews($count = 5){
	...
	public static function getKeyWordNews($keyWord,$count = 5){
		return self::getNews('http://news.baidu.com/ns?word='.$keyWord.'&tn=newsrss&sr=0&cl=2&rn=20&ct=0', $count);
	}
